...
$docfees=$_POST['docfee'];
$doccontactno=$_POST['contact'];
$docemail=$_POST['docemail'];
$password=md5($_POST['password']);
$sql=mysqli_query($con,"insert into doctors(specilization,doctorname,address,docfee,contact,docEmail,password) values('$docspecialization','$doctorname','$address','$docfee','$contact','$docemail','$password')");
if($sql)
{
